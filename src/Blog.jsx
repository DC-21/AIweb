...
function Blog() {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-3xl text-2xl font-bold title-font mb-4 text-black">Master The Future Of AI</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed font-bold text-black text-xl">Mastering the future of AI requires adaptability, innovation, and ethical considerations for a truly transformation impact.</p>
    </div>
