      ...
      <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
        ...
        <div className="lg:w-1/3 md:w-1/2 mr-16 bg-indigo-300 bg-opacity-50 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
          ...
          <div className="relative mb-4">
            ...
            <input type="text" id="full-name" name="full-name" className="w-full white focubg-s:ring-2 focus:ring-indigo- rounded border border-gray-600 focus:border-indigo-500 text-base outline-none text-black py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
          </div>
          <div className="relative mb-4">
            <label htmlFor="email" className="leading-7 text-sm text-blue-600 font-bold">Email</label>
            <input type="email" id="email" name="email" className="w-full white focubg-s:ring-2 focus:ring-indigo- rounded border border-gray-600 focus:border-indigo-500 text-base outline-none text-black py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
          </div>
